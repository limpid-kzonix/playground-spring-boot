...
public class ServicePriceController extends AbstractOrganizationController {
    ...
    @PutMapping(path = "/{organization-id}/services/{service-id}/timesheet/{day}")
    @ResponseStatus(HttpStatus.CREATED)
    public ResponseMessage.Option<LocalDateTime> updatePriceForDay(
        ...
        return serviceScopeTimeSheetService.mergeDaysPrices(day, servicePricePayload.getServicePricePayload(), serviceId, organizationId, userEntity);
    }

    @DeleteMapping(path = "/{organization-id}/services/{service-id}/timesheet/{day}")
