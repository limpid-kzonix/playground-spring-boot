...
@Slf4j
@Service("facebookSingInService")
public class FacebookSingInServiceImpl implements OAuthSignInService {

    private final OAuthApiExplorer oAuthApiExplorer;
    private final SignInAdapter signInAdapter;

    public FacebookSingInServiceImpl(@Qualifier("facebookApiExplorer") OAuthApiExplorer oAuthApiExplorer,
