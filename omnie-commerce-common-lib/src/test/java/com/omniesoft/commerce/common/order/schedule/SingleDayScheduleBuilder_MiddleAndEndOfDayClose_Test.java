 ...
 * @since 01.11.17
 */
public class SingleDayScheduleBuilder_MiddleAndEndOfDayClose_Test extends AbstractSingleDayScheduleBuilderTest {
    private final Logger log = LoggerFactory.getLogger(SingleDayScheduleBuilder_MiddleAndEndOfDayClose_Test.class);
