 ...
 * @since 01.11.17
 */
public class SingleDayScheduleBuilder_StartAndMiddleOfDayClose_Test extends AbstractSingleDayScheduleBuilderTest {
    private final Logger log = LoggerFactory.getLogger(SingleDayScheduleBuilder_StartAndMiddleOfDayClose_Test.class);
    ...
    public void threeSettingManySlot() throws Exception {
        ...
        ScheduleSetting s3 = getScheduleSetting(
                ...
                LocalTime.of(23, 59));
        Map<DayOfWeek, List<
                ScheduleSetting>> schedule = new HashMap<>();
        schedule.put(s1.getDay(), Arrays.asList(s1, s2, s3));
