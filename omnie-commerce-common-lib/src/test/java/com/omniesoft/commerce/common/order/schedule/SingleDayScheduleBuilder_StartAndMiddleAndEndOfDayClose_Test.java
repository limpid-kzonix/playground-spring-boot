 ...
 * @since 01.11.17
 */
public class SingleDayScheduleBuilder_StartAndMiddleAndEndOfDayClose_Test extends AbstractSingleDayScheduleBuilderTest {
    private final Logger log = LoggerFactory.getLogger(SingleDayScheduleBuilder_StartAndMiddleAndEndOfDayClose_Test.class);
