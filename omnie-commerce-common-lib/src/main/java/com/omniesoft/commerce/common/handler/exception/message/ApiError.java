...
public class ApiError {
    ...
    public ApiError withDetailedCode(ErrorCode code) {
        this.detailedCode = code.getCode();
        return this;
    }

    public void setDetailedCode(Integer code) {
        this.detailedCode = code;
    }

    public void setDetailedCode(ErrorCode code) {
        this.detailedCode = code.getCode();
    }
